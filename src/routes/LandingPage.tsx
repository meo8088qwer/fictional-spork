...
const TIERS = [
  ...
  },
  {
    ...
    price: '월 4,900원',
    limit: '학생 최대 150명',
    features: ['커스텀 종목 +3개 추가', '기록관리 (전체 이력)', '엑셀 대량 등록', '전체랭킹 참가'],
    highlight: true,
  },
  {
    key: 'pro',
        ...
        <footer className="border-t border-slate-200/80">
          ...
          <div className="max-w-5xl mx-auto px-4 lg:px-8 pb-10">
            <p className="text-[11px] text-slate-400 font-medium leading-relaxed text-center sm:text-left">
              줄프로(JULPRO) · 대표 정승현 · 사업자등록번호 172-48-01397 · 통신판매업신고번호 제2026-경기파주-3725호 · 경기도 파주시 초롱꽃로 117-36, 413호 · 031-945-6778 · meo8088@naver.com
            </p>
          </div>
        </footer>
      </main>
