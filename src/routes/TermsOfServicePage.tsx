      ...
      <main className="max-w-3xl mx-auto px-4 lg:px-8 py-10">
        ...
        <Section title="제7조 (이용요금 및 결제)">
          <ul className="list-disc pl-5 space-y-1.5">
            ...
            <li>
              <strong>유료 플랜은 토스페이먼츠의 자동결제(빌링) 방식으로 결제됩니다.</strong> 최초 결제 시
              회원의 카드 정보를 등록하며, 이후 결제 주기(월간/연간)마다 등록된 카드로 자동으로 결제가
              청구됩니다. 회원은 마이페이지에서 언제든지 구독을 해지하여 다음 결제부터 청구를 중단할 수
              있습니다.
            </li>
            <li>
              자동결제가 실패하는 경우 최대 3회까지 재시도하며, 계속 실패할 경우 무료 플랜(FREE)으로
              전환됩니다.
            </li>
            <li>결제는 토스페이먼츠를 통한 신용/체크카드 결제로 처리되며, 카드 정보는 회사 서버에 저장되지 않고 토스페이먼츠가 발급한 빌링키로만 관리됩니다.</li>
            <li>
        ...
        <Section title="제8조 (계약해지 및 환불)">
          <ul className="list-disc pl-5 space-y-1.5">
            ...
            <li>
              해지하더라도 이미 결제한 기간(월간/연간) 동안은 유료 플랜 기능이 계속 제공되며, 그 기간이
              끝나면 자동으로 무료 플랜(FREE)으로 전환됩니다. 제7조의 7일 청약철회 기간이 지난 뒤에는
              남은 이용 기간에 대한 환불은 제공되지 않습니다.
            </li>
            <li>
              이중 결제, 서비스 오류 등 회사의 귀책사유로 인한 경우에는 해당 결제 건 전액을 환불합니다.
            </li>
            <li>
