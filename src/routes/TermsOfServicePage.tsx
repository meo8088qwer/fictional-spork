      ...
      <main className="max-w-3xl mx-auto px-4 lg:px-8 py-10">
        ...
        <Section title="제7조 (이용요금 및 결제)">
          <ul className="list-disc pl-5 space-y-1.5">
            ...
            <li>
              회원은 「전자상거래 등에서의 소비자보호에 관한 법률」 제17조에 따라 결제일로부터 7일 이내에는
              청약철회(단순 변심 포함)를 요청할 수 있습니다. 다만 회원이 유료 플랜의 기능(커스텀 종목 추가,
              엑셀 대량 등록 등)을 실제로 이용한 경우에는 같은 법 제17조 제2항에 따라 청약철회가 제한될 수
              있으며, 이 경우 제8조에 따른 일할 계산 환불이 적용됩니다.
            </li>
          </ul>
        </Section>

        <Section title="제8조 (계약해지 및 환불)">
          <ul className="list-disc pl-5 space-y-1.5">
            <li>
              회원은 마이페이지의 "구독 해지" 기능을 통해 언제든지 자유롭게 유료 플랜을 해지할 수 있습니다.
              별도의 위약금이나 장기 약정 조건은 없습니다.
            </li>
            <li>
              <strong>환불 계산 방식(일할 계산):</strong> 회원이 결제 후 아직 이용하지 않은 잔여 기간에 대해
              마이페이지의 "환불 문의"로 환불을 요청하면, 회사는 아래 기준으로 계산한 잔여 이용료를 환불합니다.
              <ul className="list-[circle] pl-5 mt-1.5 space-y-1">
                <li>
                  월간 결제 회원: 월 기준을 30일로 보고, 월 이용료를 30으로 나눈 1일 이용료에 결제일부터
                  환불 신청일까지 실제 이용한 일수를 곱해 공제한 뒤 나머지 금액을 환불합니다.
                </li>
                <li>
                  연간 결제 회원: 연 기준을 12개월(360일)로 보고, 연간 이용료를 360으로 나눈 1일 이용료를
                  기준으로 동일한 방식(실이용일수 공제 후 잔액 환불)으로 계산합니다.
                </li>
              </ul>
            </li>
            <li>
              얼리어답터 이벤트 등으로 무상 제공된 기간(예: 무료 체험)은 결제한 금액이 없으므로 환불 계산에서
              제외됩니다. 무상 제공 기간이 끝난 뒤 실제로 결제한 금액부터 위 일할 계산이 적용됩니다.
            </li>
            <li>
              이중 결제, 서비스 오류 등 회사의 귀책사유로 인한 경우에는 위 일할 계산과 무관하게 해당 결제
              건 전액을 환불합니다.
            </li>
            <li>
              환불 신청은 마이페이지의 "환불 문의"를 통해 접수하며, 회사는 접수일로부터 영업일 기준 3일 이내
              환불 처리를 완료합니다. 해지 시 유료 기능은 즉시 종료되고 무료 플랜으로 전환됩니다.
            </li>
            <li>
