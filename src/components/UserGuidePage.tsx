    ...
    <div className="max-w-4xl">
      ...
      <div className="space-y-5">
        ...
        <GuideSection icon={ListChecks} title="종목 관리">
          ...
          <Bullets
            items={[
              '무료 플랜은 종목 개수가 제한돼요(기본 6종목 포함). 베이직 이상은 무제한.',
        ...
        <GuideSection icon={Sparkles} title="요금제">
          <Bullets
            items={[
              'FREE: 학생 50명, 기본 6종목만, 광고 표시.',
              'BASIC: 학생 150명, 커스텀 종목/엑셀 대량 등록/기록 인증 상장/광고 제거, 전체랭킹 참가 가능.',
              'PRO: 학생 500명, 체육관 계정 2개, 로고 사용 (추후 오픈 예정 기능 포함).',
            ]}
          />
        </GuideSection>
